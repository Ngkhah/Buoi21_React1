...
export default class Item extends Component {
  ...
  <div className=" px-lg-5">
    <div className="row gx-lg-5">
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="far fa-clone btn_icon btn btn-primary btn-lg"></i>
      ...
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="fas fa-cloud-download-alt btn_icon btn btn-primary btn-lg"></i>
      ...
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="far fa-newspaper btn_icon btn btn-primary btn-lg"></i>
      ...
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="fas fa-bold btn_icon btn btn-primary btn-lg"></i>
      ...
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="fas fa-code btn_icon btn btn-primary btn-lg"></i>
      ...
      <div className="col-lg-4 col-xxl-4 mb-5 item">
        <div className="card bg-light border-0 h-100">
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
            ...
            <i class="far fa-check-circle btn_icon btn btn-primary btn-lg"></i>
