...
export default class ProductShoes extends Component {
    arrProduct = [
      ...
      renderSP = ()=>{
        const jsx = this.arrProduct.map ((item,index)=>{
            return <div className="col-4 mb-5" key={index}>
                <Card product={item} />
            </div>
        });
        return jsx;
    ...
    render() {
        ...
        <div className="container-fluid" style={{height:'100vh'}}>
          <div className="row">
            <div className="col-4 nav flex-column justify-content-center nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <div className="container">
                  <h3 className="text-center nameShop" >Shoes Shop</h3>  
              <div className="row">
                  {this.renderSP()}
              </div>
              </div>
